...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{./model-manifold/model-manifold-eps-y0-colorings}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{./model-manifold/model-manifold-ball-preimage}
