...
\begin{figure}[ht!]
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{model-manifold-y0-coloring}
    \subcaption{Colored by $y_0$}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{model-manifold-eps-coloring}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{./sing-pert-continuation}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{sing-pert-init-cond-contours}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{./sing-pert-phase-plane}
...
\begin{figure}[ht!]
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{dmaps-phi1}
    \subcaption{Coloring sloppy parameter combinations by $\Phi_1$}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{dmaps-phi2}
